...
# In this case the center is at mu = 50 and the standard error is 
# SE = s/sqrt(n) = 40/sqrt(100) = 40/10 = 4 
SE <- 40/10

# This distribution is normally distributed because of the central limit theorem. 
# The fact that n = 100 makes n > 30 true indicates that we can use this idea. 
...
# # That rounds to 21.1% so have to be the correct answer.
